...
EDAD_conti <- mktg_imp[, !sapply(imputed, is.factor)]
EDAD_categ <- mktg_imp[, sapply(imputed, is.factor)]
```
...
p.mat <- cor.mtest(EDAD_conti)
correlation <- cor(EDAD_conti)
...
ldabo.data$y <- as.numeric(as.factor(lda.b.data$y))
...
## Objective 2 Results
```{r}
SR.O.results <- cbind("Simple LR Original",simple.o.acc, simple.o.sens, simple.o.spec, simple.o.misc, simple.o.auc)
SR.B.results <- cbind("Simple LR Balanced",simple.b.acc, simple.b.sens, simple.b.spec, simple.b.misc, simple.b.auc)
SR.R.results <- cbind("Simple LR Rose",simple.r.acc, simple.r.sens, simple.r.spec, simple.r.misc, simple.r.auc)
...
colnames(accuracy) <- c("Method", "Accuracy", "Sensitivity", "Specificity", "Misclassification Rate", "AUC")
