...
# Error
lda.o.error <- mean(as.numeric(lqda.orig.test$y) != as.numeric(lda.o.predictions$class))
lda.o.error
...
## Objective 2 Results
```{r}
OBJ1.results <- cbind("Simple Obj 1 Model", obj1.mod.acc, obj1.mod.sens, obj1.mod.spec)
OBJ2.results <- cbind("Complex Obj 2 Model", obj1.mod2.acc, obj1.mod2.sens, obj1.mod2.spec)
...
accuracy <- rbind(OBJ1.results, OBJ2.results,
